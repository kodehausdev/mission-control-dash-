...
function LoginFormInner({ workspaceName }: { workspaceName: string }) {
  ...
  return (
    <div className="grid min-h-screen place-items-center bg-bg p-5">
      <div className="w-full max-w-[360px]">
        <BrandHeader workspaceName={workspaceName} />
...
export function LoginForm({ workspaceName }: { workspaceName: string }) {
  return (
    <Suspense>
      <LoginFormInner workspaceName={workspaceName} />
    </Suspense>
  );
}
